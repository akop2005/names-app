...
Если надо будет загружать проект и компелировать: если открывать, то лучше через VS Code, потому что у меня там все работало. Если в какой-то части я написала, что надо открывать через гугл коллаб, то надо открывать через коллаб и подгрузить необходимые файлы.
